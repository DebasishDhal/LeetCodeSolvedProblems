...
Beats 50% of users in TypeScript.
*/
...
function numSpecial(mat: number[][]): number {
    ...
    for (let i=0; i<specialRows.length; i++){ //For all row_number in specialRows, find which column of that row has element 1, and check if that element is in specialRows.
